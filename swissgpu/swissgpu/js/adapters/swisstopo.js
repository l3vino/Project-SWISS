...
export const swisstopo = defineAdapter({
  ...
  /**
   * 3D Tiles sets. `kind` picks how the engine draws a set; only buildings
   * are drawn so far, the rest are declared for the steps that add them.
   */
  features: [
    {
    ...
    { id: 'tlm', label: 'Roads, railways and water', kind: 'tlm', codec: 'b3dm',
