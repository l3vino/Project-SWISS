...
export const SCHEMA = [
  ...
  },
  {
    id: 'physics', label: 'Physics', items: [
      ...
      { id: 'flyThrough', label: 'Fly through buildings', type: 'toggle', default: false,
        hint: 'Off: buildings and bridges are solid while flying too, like the ground. Walking always collides.' },
    ],
  },
  {
  ...
  },
  {
    id: 'layers', label: 'Layers', items: [
      ...
      { id: 'structures', label: 'Bridges & structures', type: 'toggle', default: true,
      ...
      { id: 'buildingMemory', label: 'Building memory', type: 'select', default: 256,
        options: [[128, '128 MB'], [256, '256 MB'], [512, '512 MB'], [1024, '1 GB']],
        hint: 'Memory kept for building and bridge tiles, including what collision uses. The ones out of sight longest are dropped first.' },
    ],
  },
  {
