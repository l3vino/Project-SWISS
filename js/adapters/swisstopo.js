...
import { BUILDING_APPEARANCE, STRUCTURE_APPEARANCE } from './swisstopo-buildings.js';
  ...
  features: [
    {
      ...
      maxError: 10,
      // Which batch table columns say what each building is and which one it
      // is, and how Swiss buildings look (swisstopo-buildings.js): what each
      // type is made of, and the rules for the ordinary ones by region,
      // altitude and shape. Underground and invisible ones are not drawn.
      attributes: { id: 'EGID', type: 'OBJEKTART', appearance: BUILDING_APPEARANCE },
    },
    {
      ...
      memoryShare: 0.25,
      // Concrete, and anything that is an ordinary building is left to the
      // building layer.
      attributes: { type: 'OBJEKTART', appearance: STRUCTURE_APPEARANCE },
    },
